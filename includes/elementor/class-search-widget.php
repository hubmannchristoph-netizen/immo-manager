...
class SearchWidget extends Widget_Base {
	...
	private function render_lightbox_trigger() {
		...
		<div class="immo-search-trigger" id="immo-search-trigger-<?php echo esc_attr( $this->get_id() ); ?>">
			<button class="immo-btn-search-icon" aria-label="<?php esc_attr_e( 'Suche öffnen', 'immo-manager' ); ?>" style="background:none;border:none;cursor:pointer;padding:8px;color:var(--immo-accent);">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="immo-icon-search-svg"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
			</button>
		</div>
		<script>
