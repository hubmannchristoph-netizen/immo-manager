...
<div class="immo-wizard-section immo-project-parking-section" style="display:none;">
	...
	<div class="immo-wizard-fields">
		<div class="immo-field immo-field--quarter">
			<input type="hidden" name="_immo_parking_garage_available" value="0" class="immo-wizard-input">
			<label><input type="checkbox" name="_immo_parking_garage_available" value="1" class="immo-wizard-input" <?php checked( ! empty( $prefill['_immo_parking_garage_available'] ) ); ?>> <?php esc_html_e( 'Verfügbar', 'immo-manager' ); ?></label>
		</div>
		<div class="immo-field immo-field--quarter">
		...
		<div class="immo-field immo-field--quarter">
			<input type="hidden" name="_immo_parking_garage_required" value="0" class="immo-wizard-input">
			<label><input type="checkbox" name="_immo_parking_garage_required" value="1" class="immo-wizard-input" <?php checked( ! empty( $prefill['_immo_parking_garage_required'] ) ); ?>> <?php esc_html_e( 'Verpflichtend', 'immo-manager' ); ?></label>
		</div>
	</div>
	...
	<div class="immo-wizard-fields">
		<div class="immo-field immo-field--quarter">
			<input type="hidden" name="_immo_parking_outdoor_available" value="0" class="immo-wizard-input">
			<label><input type="checkbox" name="_immo_parking_outdoor_available" value="1" class="immo-wizard-input" <?php checked( ! empty( $prefill['_immo_parking_outdoor_available'] ) ); ?>> <?php esc_html_e( 'Verfügbar', 'immo-manager' ); ?></label>
		</div>
		<div class="immo-field immo-field--quarter">
			<label><?php esc_html_e( 'Anzahl', 'immo-manager' ); ?></label>
		...
		<div class="immo-field immo-field--quarter">
			<input type="hidden" name="_immo_parking_outdoor_required" value="0" class="immo-wizard-input">
			<label><input type="checkbox" name="_immo_parking_outdoor_required" value="1" class="immo-wizard-input" <?php checked( ! empty( $prefill['_immo_parking_outdoor_required'] ) ); ?>> <?php esc_html_e( 'Verpflichtend', 'immo-manager' ); ?></label>
		</div>
	</div>
